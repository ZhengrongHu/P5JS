...
#3: 
  at the loadImage line, it begins to load the image, but continues on through the rest of setup() and on to draw() before the image has completely loaded
  
#4: 
  A callback function is passed as an argument to a second functionm, and runs after the second function has completed. 
*/
